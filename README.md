...
Available for freelance development and open-source contribution work,
particularly debugging existing codebases and building data integrations.
...
| [mustangproject #1276](https://github.com/ZUGFeRD/mustangproject/pull/1276) | Prevented unparseable discount terms from aborting an invoice import. | Java |
